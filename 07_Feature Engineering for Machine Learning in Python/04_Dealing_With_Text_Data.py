...
print(cv_array.shape) # Did you notice that the number of features (unique words) greatly reduced from 9043 to 818?
...
cv_trigram = cv_trigram_vec.fit_transform(speech_df['text_clean']).toarray()
